    ...
    <>
      ...
      <div className="flex flex-col items-center md:flex-row h-full w-full p-3">
        <div className="md:h-full w-full md:w-[50%] gap-2">
          ...
          <div className=" flex flex-col items-center h-[600px]  gap-2 p-3 overflow-auto">
            {incomes &&
        ...
        <div className=" flex flex-col items-center h-250 md:h-full w-full md:w-[50%] gap-2 p-3">
